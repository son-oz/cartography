...
MOCK_ENTRA_TENANT = Organization(
    ...
    assigned_plans=[
        AssignedPlan(
            additional_data={},
            assigned_date_time=datetime.datetime(2025, 4, 7, 18, 52, 15, tzinfo=datetime.timezone.utc),
    ...
    created_date_time=datetime.datetime(2025, 4, 5, 2, 8, 28, tzinfo=datetime.timezone.utc),
    ...
    on_premises_last_sync_date_time=datetime.datetime(2025, 4, 16, 3, 44, 33, tzinfo=datetime.timezone.utc),
